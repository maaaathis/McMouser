// Native macOS input fix for McMouser.
//
...
//
// Compiled (default, non-ARC) ObjC++ into a universal dylib. See build.gradle.
...
Java_me_virb3_mcmouser_client_Native_registerKeyCallback(JNIEnv* env, jclass, jobject keyCallback, jlong cocoaWindow) {
    ...
    jclass cbClass = env->FindClass("me/virb3/mcmouser/client/KeyCallback");
